...
ArrayList<TextView> setTextView= new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.matrix5);
        ...
        final TextView tv18=(TextView) findViewById(R.id.tv18); setTextView.add(tv18);
        ...
        final TextView tv28=(TextView) findViewById(R.id.tv28); setTextView.add(tv28);
        ...
        final  TextView tv38=(TextView) findViewById(R.id.tv38); setTextView.add(tv38);
        ...
        final TextView tv48=(TextView) findViewById(R.id.tv48); setTextView.add(tv48);
        ...
        final TextView tv58=(TextView) findViewById(R.id.tv58); setTextView.add(tv58);
        ...
        final TextView tv68=(TextView) findViewById(R.id.tv68); setTextView.add(tv68);
        ...
        final TextView tv78=(TextView) findViewById(R.id.tv78); setTextView.add(tv78);
        final TextView tv81=(TextView) findViewById(R.id.tv81); setTextView.add(tv81);
        final TextView tv82=(TextView) findViewById(R.id.tv82); setTextView.add(tv82);
        final TextView tv83=(TextView) findViewById(R.id.tv83); setTextView.add(tv83);
        final TextView tv84=(TextView) findViewById(R.id.tv84); setTextView.add(tv84);
        final TextView tv85=(TextView) findViewById(R.id.tv85); setTextView.add(tv85);
        final TextView tv86=(TextView) findViewById(R.id.tv86); setTextView.add(tv86);
        final TextView tv87=(TextView) findViewById(R.id.tv87); setTextView.add(tv87);
        final TextView tv88=(TextView) findViewById(R.id.tv88); setTextView.add(tv88);
...
for (int i=0; i<20; i++){
    ...
    setTextView.get(p).setBackgroundColor(Color.GREEN);
        ...
        textLevels.setText(R.string.Lesson4Level5);
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(matrixSet.equals(matrixSetPerson)){
                    ...
                    dialog2 = new Dialog(Level20.this);
