...
public class Level14Array extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Level14Array.this, GameLevels.class);
        ...
        arrayListShaffle=(ArrayList)Level14.arrayListOriginals.clone();
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog2 = new Dialog(Level14Array.this);
                ...
                btnClose.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Level14Array.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
                });
                ...
                for(int i=0; i<arrayListShaffle.size(); i++){
                    arrayListOriginals2.add(getString(Level14.arrayListOriginals.get(i)));
                }
                ...
                if(arrayListOriginals2.equals(arrayListPerson)){
                    ...
                    btnPlayAgain.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(Level14Array.this, Level14.class);
                            startActivity(intent);
                            finish();
                        }
                    });
