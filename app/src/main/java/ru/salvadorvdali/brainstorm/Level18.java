...
public class Level18 extends AppCompatActivity implements View.OnClickListener{
...
for (int i=0; i<15; i++){
    ...
    setTextView.get(p).setBackgroundColor(Color.GREEN);
        ...
        textLevels.setText(R.string.Lesson4Level3);
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(matrixSet.equals(matrixSetPerson)){
                    ...
                    dialog2 = new Dialog(Level18.this);
