...
public class Level15Array extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Level15Array.this, GameLevels.class);
        ...
        TextView tvword7 = (TextView) findViewById(R.id.tvword7);
        ...
        TextView tvword12 = (TextView) findViewById(R.id.tvword12);

        //Задаем переменные - конец

        // Создаем переменную TextLevels
        TextView textLevels = findViewById(R.id.textLevels);
        textLevels.setText(R.string.Lesson3Level5);

        // сортируем список и присваиваем значения - начало
        arrayListShaffle=(ArrayList)Level15.arrayListOriginals.clone();
        ...
        tvword7.setText(arrayListShaffle.get(8));
        tvword1.setText(arrayListShaffle.get(9));
        tvword6.setText(arrayListShaffle.get(10));
        tvword12.setText(arrayListShaffle.get(11));
        ...
        tvword7.setOnClickListener(this);
        tvword1.setOnClickListener(this);
        tvword6.setOnClickListener(this);
        tvword12.setOnClickListener(this);
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog2 = new Dialog(Level15Array.this);
                ...
                btnClose.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Level15Array.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
                });
                ...
                for(int i=0; i<arrayListShaffle.size(); i++){
                    arrayListOriginals2.add(getString(Level15.arrayListOriginals.get(i)));
                }
                ...
                if(arrayListOriginals2.equals(arrayListPerson)){
                    ...
                    btnPlayAgain.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(Level15Array.this, Level15.class);
                            startActivity(intent);
                            finish();
                        }
                    });
