...
public class Level8 extends AppCompatActivity {
    ...
    int getLetter1, getLetter2, getLetter3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.Lesson2Level3);
...
//создаем второе диалоговое окно с цифрой
                dialog2 = new Dialog(Level8.this);
        ...
        imgNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < chars.length; i++) {
                    ...
                    dialog3 = new Dialog(Level8.this);
                    dialog3.requestWindowFeature(Window.FEATURE_NO_TITLE);// скрываем заголовок
                    dialog3.setContentView(R.layout.dialog_input_letters3);
                    ...
                    buttonNext.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            try{
                                ...
                                if(getLetter1==countLetter && getLetter2==countLetter2 && getLetter3==countLetter3){
                                     dialog3.dismiss();
                                        dialog4 = new Dialog(Level8.this);
                                    ...
                                    tvfinish.setText(getString(R.string.nice_try)+
                                            ...
                                            countLetter3+getString(R.string.try_again));
                                    dialog4.show();
                                    Button btnPlayAgain= (Button) dialog4.findViewById(R.id.buttonnext);
                                ...
                                Toast.makeText(Level8.this, R.string.enter_numbers, Toast.LENGTH_SHORT).show();
                            }
