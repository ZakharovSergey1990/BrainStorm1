...
public class Level4 extends AppCompatActivity {
    ...
    public int x, y, x1, z, a;
    Random random = new Random();
    public int count = 0;
    boolean f=true;
    int p;
    String[] arrayString = new String[]{"+", "-", "x"};
    EditText inputX, inputY, inputZ, inputA;
    int getX, getY, getZ, getA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.Lesson1Level4);
...
//создаем второе диалоговое окно с цифрой
                dialog2 = new Dialog(Level4.this);
            ...
            imgNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                 if(count<14){
                     ...
                     //
                     if (count==0 | count==4| count==8|count==12) { TextView textl1l1 = (TextView) findViewById(R.id.l1l1);
                         int n = random.nextInt(2);
                         p=random.nextInt(10);
                     ...
                     else if(count==1 | count==5| count==9| count==13){
                         TextView textl1l1 = (TextView) findViewById(R.id.l1l1);
                         int n = random.nextInt(2);
                         p=random.nextInt(10);
                     ...
                     dialog3 = new Dialog(Level4.this);
                     dialog3.requestWindowFeature(Window.FEATURE_NO_TITLE);// скрываем заголовок
                     dialog3.setContentView(R.layout.dialog_input_number4);
                     ...
                     buttonNext.setOnClickListener(new View.OnClickListener() {
                         ...
                         public void onClick(View v) {
                             ...
                             try{getX=Integer.parseInt(inputX.getText().toString());
                                 ...
                                 if(getY==y && getX==x && getZ==z&& getA==a)
                                 { dialog3.dismiss();
                                     ...
                                     dialog4 = new Dialog(Level4.this);
                                     ...
                                     dialog4.setCancelable(false);
                                     TextView tvfinish= (TextView) dialog4.findViewById(R.id.tvfinish);
                                     tvfinish.setText(getString(R.string.nice_try)+"X="+x+", Y="+y+", Z="+z+", A="+a+getString(R.string.try_again));
                                     dialog4.show();
                                     Button btnPlayAgain= (Button) dialog4.findViewById(R.id.buttonnext);
                                     ...
                                     (Level4.this, R.string.enter_numbers, Toast.LENGTH_SHORT).show();}}
