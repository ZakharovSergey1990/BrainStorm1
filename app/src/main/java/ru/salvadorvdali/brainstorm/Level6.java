...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.Lesson2Level1);
...
//создаем второе диалоговое окно с цифрой
                dialog2 = new Dialog(Level6.this);
        ...
        imgNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < chars.length; i++) {
                    ...
                    dialog3 = new Dialog(Level6.this);
                    dialog3.requestWindowFeature(Window.FEATURE_NO_TITLE);// скрываем заголовок
                    dialog3.setContentView(R.layout.dialog_input_letters1);
                    ...
                    buttonNext.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            try{
                                ...
                                if(getLetter1==countLetter){
                                     dialog3.dismiss();
                                        dialog4 = new Dialog(Level6.this);
                                    ...
                                    tvfinish.setText(getString(R.string.nice_try)+
                                            getString(letter1)+"- "+countLetter+getString(R.string.try_again));
                                    dialog4.show();
                                    Button btnPlayAgain= (Button) dialog4.findViewById(R.id.buttonnext);
                                ...
                                Toast.makeText(Level6.this, R.string.enter_numbers, Toast.LENGTH_SHORT).show();
                            }
