...
public class Level9 extends AppCompatActivity {
    ...
    int getLetter1, getLetter2, getLetter3, getLetter4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.Lesson2Level4);
...
//создаем второе диалоговое окно с цифрой
                dialog2 = new Dialog(Level9.this);
                ...
                tvX.setText(getString(letter1)+", "+ getString(letter2)+", "+ getString(letter3)+", "+ getString(letter4));
        ...
        imgNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < chars.length; i++) {
                    ...
                    dialog3 = new Dialog(Level9.this);
                    dialog3.requestWindowFeature(Window.FEATURE_NO_TITLE);// скрываем заголовок
                    dialog3.setContentView(R.layout.dialog_input_letters4);
                        ...
                        public void onClick(View v) {
                            ...
                            try{
                                ...
                                if(getLetter1==countLetter && getLetter2==countLetter2 &&
                                        getLetter3==countLetter3 && getLetter4==countLetter4){
                                     dialog3.dismiss();
                                        dialog4 = new Dialog(Level9.this);
                                    ...
                                    tvfinish.setText(getString(R.string.nice_try)+
                                            ...
                                            countLetter4+getString(R.string.try_again));
                                    dialog4.show();
                                    Button btnPlayAgain= (Button) dialog4.findViewById(R.id.buttonnext);
                                ...
                                Toast.makeText(Level9.this, R.string.enter_numbers, Toast.LENGTH_SHORT).show();
                            }
