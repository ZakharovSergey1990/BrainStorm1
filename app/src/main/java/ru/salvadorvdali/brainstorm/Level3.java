...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.Lesson1Level3);
...
//создаем второе диалоговое окно с цифрой
                dialog2 = new Dialog(Level3.this);
            ...
            imgNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                 if(count<14){
                     ...
                     //
                     if (count==0 | count==3| count==6| count==9| count==12) { TextView textl1l1 = (TextView) findViewById(R.id.l1l1);
                         int n = random.nextInt(2);
                         p=random.nextInt(10);
                     ...
                     else if(count==1 | count==4| count==7| count==10| count==13){
                         TextView textl1l1 = (TextView) findViewById(R.id.l1l1);
                         int n = random.nextInt(2);
                         p=random.nextInt(10);
                     ...
                     dialog3 = new Dialog(Level3.this);
                     dialog3.requestWindowFeature(Window.FEATURE_NO_TITLE);// скрываем заголовок
                     dialog3.setContentView(R.layout.dialog_input_number3);
                             ...
                             try{getX=Integer.parseInt(inputX.getText().toString());
                                 ...
                                 { dialog3.dismiss();
                                     ...
                                     if(level1>3){}
                                         ...
                                         editor.putInt("Level1", 4);
                                         editor.commit();
                                     }
                                     //сохраняем прогресс игры - конец
                                     dialog4 = new Dialog(Level3.this);
                                     ...
                                     dialog4.setCancelable(false);
                                     TextView tvfinish= (TextView) dialog4.findViewById(R.id.tvfinish);
                                     tvfinish.setText(getString(R.string.nice_try)+"X="+x+", Y="+y+", Z="+z+getString(R.string.try_again));
                                     dialog4.show();
                                     Button btnPlayAgain= (Button) dialog4.findViewById(R.id.buttonnext);
                                     ...
                                     (Level3.this, R.string.enter_numbers, Toast.LENGTH_SHORT).show();}}
